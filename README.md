...
Dedicated to **programmable logic, microcontroller, kernel, firmware, and bare-metal systems**. Projects involving low-level programming, reverse engineering, bit manipulation, and memory management.
